About esmbenchmarkviz-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/esmbenchmarkviz-feedstock/blob/main/LICENSE.txt)

Home: https://github.com/PCMDI/ESMBenchmarkViz

Package license: BSD-3-Clause

Summary: A Python toolkit for interactive visualizations for Earth System Model evaluation and benchmarking
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/esmbenchmarkviz-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/esmbenchmarkviz-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add esmbenchmarkviz
# for installing globally
pixi global install esmbenchmarkviz
```
...
It is possible to list all of the versions of `esmbenchmarkviz` available on your platform:
...
```
pixi search esmbenchmarkviz --channel conda-forge
```
...
Updating esmbenchmarkviz-feedstock
==================================

If you would like to improve the esmbenchmarkviz recipe or build a new
...
Note that all branches in the conda-forge/esmbenchmarkviz-feedstock are
